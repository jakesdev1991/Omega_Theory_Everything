...
The product scope is `app/**`, `rust/**`, `whitepapers/**`, and `tri_token_sovereign_economy_blueprint.md`. These files carry or inherit the proprietary identifier `LicenseRef-Omega-Product-Proprietary`; see [`LICENSES/Omega-Product-Proprietary.txt`](../LICENSES/Omega-Product-Proprietary.txt).
